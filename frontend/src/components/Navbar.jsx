        ...
        <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800'>
            <div className='container mx-auto px-4 py-3'>
                <div className='flex flex-wrap justify-between items-center'>
                    ...
                    <nav className='flex flex-group items-center gap-4'>
                        <Link to="/">Home</Link>
                        ...
                        {user ? (<button className='bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-200 ease-in-out' onClick={handleLogout}>Log Out</button>) : (
                            <>
                                ...
                                <Link to={"/login"} className='bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 flex rounded-md items-center transition duration-300 ease-in-out'>
