                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        <div>
                            ...
                            <div className='mt-1 relative rounded-md shadow-sm'>
                                ...
                                <input type="text" required value={frameData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500  sm:text-sm' placeholder='John Doe' />
                            </div>
                        </div>
